...
def draw_bounding_boxes(file_path):
    ...
    output_file_name = f'{detected_class}_{os.path.basename(file_path)}'
    cv2.imwrite(output_file_name, img)

file_path = '../img/download.jpg'
draw_bounding_boxes(file_path)
